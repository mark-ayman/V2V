...
#warning "Please check if the HSE is stable if not please disable CSS" // you enable the CLOCK_SECURITY_SYSTEM(CSS) are you sure the HSE is enable and stable
#else
