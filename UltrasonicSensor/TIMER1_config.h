 ...
 *                       5) PRESCALER_BY_256
 *                       6) PRESCALER_BY_1024
 *                       7) EXTERNAL_CLOCK_FALLING_EDGE_T1Pin      // PORTB-pin0
 *                       8) EXTERNAL_CLOCK_RISING_EDGE_T1Pin
 * */
...
#define COMPARE_PHASECORRECT_PWM     NORMAL_MODE
#endif
